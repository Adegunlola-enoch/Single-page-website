...
(function () {
  ...
  function dirPaginationControlsTemplateInstaller($templateCache) {
    $templateCache.put(
      ...
      '<li ng-if="boundaryLinks"><a href="" ng-class="{ disabled : pagination.current == 1 }" ng-click="setCurrent(1)">&laquo;</a></li>' +
      '<li ng-if="directionLinks" class="visible-mobile"><a href="" class="prev" ng-class="{ disabled : pagination.current == 1 }" ng-click="setCurrent(pagination.current - 1)"><span></span></a></li>' +
      '<li ng-repeat="pageNumber in pages track by tracker(pageNumber, $index)"><a href="" ng-class="{ active : pagination.current == pageNumber, disabled : pageNumber == \'...\' || ( ! autoHide && pages.length === 1 ) }" ng-click="setCurrent(pageNumber)">{{ pageNumber }}</a></li>' +
      '<li ng-if="directionLinks" class="visible-mobile"><a href="" class="next" ng-class="{ disabled : pagination.current == pagination.last }" ng-click="setCurrent(pagination.current + 1)"><span></span></a></li>' +
      '<li ng-if="boundaryLinks"><a href="" ng-class="{ disabled : pagination.current == pagination.last }" ng-click="setCurrent(pagination.last)">&raquo;</a></li>'+
      '</ul>'
    );
  }
